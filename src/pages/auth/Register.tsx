        ...
        <div className="">
          ...
          <div className="w-[580px] flex">
            ...
            >
              ...
              {/* image */}
              <img
                className="object-cover  w-[70px] h-[70px] rounded-[35px] bg-slate-500 "
                src={avatar}
              />
              ...
              <label
                htmlFor="id"
                className="mr-[60px] mb-4 text-rose-500 cursor-pointer text-[20px]"
              >
                {" "}
                <BsCamera />
              </label>
              ...
              <div className="border-b-2 h-[40px] w-full">
                <input
                  className=" outline-none w-full placeholder: text-[13px] bg-white"
